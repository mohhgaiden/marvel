...
class _$BookmarkImpl implements _Bookmark {
  _$BookmarkImpl(this.id, this.name, this.image);
  ...
  @override
  String toString() {
    return 'Bookmark(id: $id, name: $name, image: $image)';
  }
...
abstract class _Bookmark implements Bookmark {
  factory _Bookmark(final String id, final String name, final String image) =
      _$BookmarkImpl;
